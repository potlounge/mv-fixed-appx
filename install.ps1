...
$112Url = 'https://github.com/potlounge/mv-fixed-appx/releases/download/1.2.0/1.12.101.0.appx'
$116Url = 'https://github.com/potlounge/mv-fixed-appx/releases/download/1.2.0/1.16.100.4.appx'
$118Url = 'https://github.com/potlounge/mv-fixed-appx/releases/download/1.2.0/1.18.12.1.appx'
...
if( Get-AppxPackage Microsoft.Services.Store.Engagement ) {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Pot-Lounge/mv-fixed-appx/master/deps/Microsoft.Services.Store.Engagement_10.0.23012.0_x64__8wekyb3d8bbwe.Appx" -OutFile $storeEngagementPath
...
if( Get-AppxPackage *vclibs.140.00* ) {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Pot-Lounge/mv-fixed-appx/master/deps/Microsoft.VCLibs.140.00_14.0.33519.0_x64__8wekyb3d8bbwe.Appx" -OutFile $vcLibsPath
    Add-AppxPackage $vcLibsPath
    Remove-Item -Path $vcLibsPath -Force
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Pot-Lounge/mv-fixed-appx/master/deps/Microsoft.VCLibs.140.00_14.0.33519.0_x86__8wekyb3d8bbwe.Appx" -OutFile $vcLibsPath
    Add-AppxPackage $vcLibsPath
    [Console]::ForegroundColor = 'green'
